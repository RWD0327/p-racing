...
- 다른 AI에서도 이어서 사용할 수 있는 문서 및 지속 기록 지침 작성.
- 문서 검토 완료. 이번 문서 커밋의 GitHub `main` 푸시가 남아 있습니다. 아래 검증 완료 기록으로 최종 상태를 확인하세요.
...
- 실제 모바일 기기 렌더링과 브라우저 CSP 집행 검사는 **미완료**입니다. Node 검사를 그 대체로 표현하지 마세요.
...
1. 실제 휴대폰·데스크톱 브라우저에서 화면 잘림, 키보드 이동, CSP 콘솔 오류 확인.
